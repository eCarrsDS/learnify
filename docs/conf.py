...
"""
learnify documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'learnify',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/ecarrsds/learnify",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'learnify'),
                os.path.join(root_path, 'learnify/migrations')])
